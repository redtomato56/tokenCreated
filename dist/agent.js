...
var handleTransaction = function (txEvent) { return __awaiter(void 0, void 0, void 0, function () {
    var findings, symbol, contract, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                findings = [];
                if (!(!txEvent.to || txEvent.to === "")) return [3 /*break*/, 5];
                if (!txEvent.receipt.contractAddress) return [3 /*break*/, 5];
                symbol = "";
                contract = new web3.eth.Contract(abi, txEvent.receipt.contractAddress);
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
